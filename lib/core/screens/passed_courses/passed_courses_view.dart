...
import 'package:dalil_project/core/widgets/ai_floating_action_button.dart';
...
class PassedCoursesView extends StatefulWidget {
  const PassedCoursesView({super.key});

  @override
  State<PassedCoursesView> createState() => _PassedCoursesViewState();
}

class _PassedCoursesViewState extends State<PassedCoursesView>
  ...
  Widget _buildTitleText() {
    return Padding(
      ...
      child: Text(
        AppStrings.coursesYouHavePassed,
